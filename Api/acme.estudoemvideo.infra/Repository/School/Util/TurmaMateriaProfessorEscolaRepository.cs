...
{
    public class TurmaMateriaProfessorEscolaRepository : RepositoryBase<TurmaProfessorEscola>, ITurmaMateriaProfessorEscolaRepository
    {
        public TurmaMateriaProfessorEscolaRepository(Context db) : base(db)
        {
        }
    }
}
