...
namespace acme.estudoemvideo.infra.Migrations
{
    ...
    [Migration("20210915194112_ModificandoAnoLetivoAddDiarioAlunosEscolaDiarioProfessorEscolaDiarioEBoletim")]
    partial class ModificandoAnoLetivoAddDiarioAlunosEscolaDiarioProfessorEscolaDiarioEBoletim
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("acme.estudoemvideo.domain.DTO.School.AlunoEscola", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlunoEscola")
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 9, 15, 16, 41, 11, 359, DateTimeKind.Local).AddTicks(2570));
            ...
            modelBuilder.Entity("acme.estudoemvideo.domain.DTO.School.Util.MateriaProfessorEscola", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("acme.estudoemvideo.domain.DTO.School.Util.TurmaMateria", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("acme.estudoemvideo.domain.DTO.School.Util.TurmaProfessorEscola", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
                    ...
                    b.ToTable("TurmaProfessorEscola");
                });
            ...
            modelBuilder.Entity("acme.estudoemvideo.domain.DTO.School.Util.TurmaProfessorEscola", b =>
                {
                    b.HasOne("acme.estudoemvideo.domain.DTO.School.ProfessorEscola", "ProfessorEscola")
                        .WithMany("TurmaProfessorEscolas")
                        .HasForeignKey("ProfessorEscolaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
