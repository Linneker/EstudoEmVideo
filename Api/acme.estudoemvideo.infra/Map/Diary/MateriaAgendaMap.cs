...
{
    public class MateriaAgendaMap : IEntityTypeConfiguration<MateriaAgenda>
    {
        public void Configure(EntityTypeBuilder<MateriaAgenda> builder)
        {
            builder.HasKey(t => t.Id);

            builder.ToTable("MateriaAgenda");
