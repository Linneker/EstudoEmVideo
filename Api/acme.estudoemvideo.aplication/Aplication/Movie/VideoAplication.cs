...
{
    public class VideoAplication : ApplicationBase<Video>, IVideoAplication
    {

        private IVideoServices _videoRepository;
        public VideoAplication(IVideoServices videoRepository): base(videoRepository)
        {
